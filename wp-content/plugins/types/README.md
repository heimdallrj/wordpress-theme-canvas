...
>Contributors: brucepearson, AmirHelzer, jozik, mihaimihai, iworks <br/>
>Donate link: http://wp-types.com <br/>
>Tags: CMS, custom field, custom fields, custom post type, custom post types, post, post type, post types, cck, taxonomy, fields <br/>
>License: GPLv2 <br/>
...
**[Video](http://vimeo.com/112053938)**
...
By default, WordPress will either display your blog posts or a specific page on the home-page. <br/>To display custom post types on the home-page, you have two options:
